...
function searchbars() {
    ...
    if (showSearchBars == true) {
        ...
        document.getElementById("searchtwo").style.display = "block";
        document.getElementById("searchthree").style.display = "block";
        document.getElementById("searchfour").style.display = "block";
...
function createCountryProfile(countryJSON) {
    ...
    var elemCountryNativeName = document.createElement("h4");
...
function showLightBox() {
    ...
    document.getElementById("message").innerHTML = message += "<br><b>Search by Region</b><p>In the region searchbar, the input options are &quot;Americas,&quot; &quot;Europe,&quot; &quot;Asia&quot; &quot;Africa,&quot; or &quot;Oceania.&quot; This will return a list of all the countries in this region.</p>";
